/**
 * Shared loading / error / empty state machine for Entity Browser lists.
 */
"use client";
...
export type EntityListQueryState = {
  ...
  onClearFilters?: () => void;
  /** Directory empty CTA — replaces `emptyMessage` when the list has no rows. */
...
export const EntityListStates = EntityListBody;
